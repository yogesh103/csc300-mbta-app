    ...
    <Container>
      <Row>
        <Col>
          ...
          <p className="lead">
            This is a 123 webapp built  using the MERN stack (MongoDB, Express, React, and Node.js) that provides information and services for the Massachusetts Bay Transportation Authority (MBTA).
          </p>
          <p>
